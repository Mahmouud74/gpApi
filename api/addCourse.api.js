            ...
            if (user) {
                if(req.file===undefined){
                    ...
                    if (courses) {
                        ...
                        await courseModel.insertMany({courseName, courseCode, courseDepartment, prerequisite , instructorId:user._id , imageUrl});
                        console.log("done");
                        res.json({message:"Course Created",message2:req.file.path});
                    }
            }
            }
            else{
